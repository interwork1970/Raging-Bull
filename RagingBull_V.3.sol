...
contract RagingBull_V3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "RagingBull V3";
    string private _symbol = "RB";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xC350004C04680339576cd7Ff479b9FA153270059); 
    address payable public teamWalletAddress = payable(0xC350004C04680339576cd7Ff479b9FA153270059); 
    ...
    uint256 public _liquidityShare = 24;
    ...
    uint256 public _totalDistributionShares = 48;
